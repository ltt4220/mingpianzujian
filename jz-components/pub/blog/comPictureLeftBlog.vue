    ...
    >
      ...
      >
        <div
          ...
          :style="{backgroundColor:settingData.BoxBackgroundColor.value,paddingRight:settingData.paddingLeftRight.value,height:parseFloat(settingData.pictureHeight.value)+parseInt(settingData.pictureLRPadding.value)*2+'px',cursor:'pointer'}"
