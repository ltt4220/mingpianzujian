    ...
    computed: {
        ...
        changemsg() {
            ...
            return `<style> 
              ...
              ${_fId}.zm-component-blog-title:hover{color:${color};cursor: pointer;}
              ${_fId}.zm-component-blog-title-a{color:${oldColor};text-decoration: none;cursor: pointer;transition: all 0.2s;}
