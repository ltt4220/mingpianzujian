    ...
    >
      ...
      >
        <div
          ...
          :style="{borderColor:settingData.boxBorderColor.value,borderWidth:settingData.boxBorderWidth.value,backgroundColor:settingData.BoxBackgroundColor.value,padding:settingData.paddingLeftRight.value,width:settingData.boxWidth.value,cursor:'pointer'}"
        >
          <div class="zm-component-blog-detail">
            ...
            >
              <div
                ...
                :style="{marginBottom:settingData.TitmarginBottom.value,textAlign:settingData.controlRowAlign.value,fontFamily:settingData.Familyfont.value.fontFamily,fontStyle:settingData.Familyfont.value.fontStyle,fontWeight:settingData.Familyfont.value.fontWeight,fontSize:settingData.Familyfont.value.fontSize,lineHeight:1.3,
