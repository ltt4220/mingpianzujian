...
<div class="wrapl" @mouseleave.stop="leave($event)">
  <div class="fontSize" id="set-fontSize" @click.stop="selFontList($event)"  ref="fontSize">
    ...
    <ul :class="{showul:showul}">
        <div class="wrap">
          <li v-text="val.fontSize" v-for="(val,index) in item" :key="index" @click.stop="selFont($event,index)"></li>
        </div>
    </ul>
  </div>
</div>
