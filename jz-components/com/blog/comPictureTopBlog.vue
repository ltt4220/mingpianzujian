<template>
  ...
  >
    <div
      ref="content"
      class="zm-component-blog-content topPic"
    ...
    >
      ...
      >
        <div
          ...
          :style="{borderColor:settingData.boxBorderColor.value,borderWidth:settingData.boxBorderWidth.value,backgroundColor:settingData.BoxBackgroundColor.value,padding:settingData.paddingLeftRight.value,width:settingData.boxWidth.value}"
        >
          <div class="zm-component-blog-detail">
            <div class="zm-component-blog-upcont">
              <div
                class="zm-component-blog-title"
                :style="{marginBottom:settingData.TitmarginBottom.value,textAlign:settingData.controlRowAlign.value,fontFamily:settingData.Familyfont.value.fontFamily,fontStyle:settingData.Familyfont.value.fontStyle,fontWeight:settingData.Familyfont.value.fontWeight,fontSize:settingData.Familyfont.value.fontSize,
                lineHeight:1.3,
              ...
              <div
                ...
                :style="{fontFamily:settingData.blogTimeFont.value.fontFamily,fontSize:settingData.blogTimeFont.value.fontSize,color:settingData.blogTimeFont.value.color,fontWeight:settingData.blogTimeFont.value.fontWeight,fontStyle:settingData.blogTimeFont.value.fontStyle,textAlign:settingData.blogTimeAlign.value,paddingBottom:settingData.blogTimeBottom.value,display:settingData.blogShow.num}"
              >
              ...
              <div
                ...
                :style="{display:settingData.pictureShow.value,height:settingData.pictureHeight.value,marginBottom:setMarBot}"
              >
                <div
              ...
              <div
                ...
                :style="{height:settingData.lineHeightNum.num,fontFamily:settingData.blogContFont.value.fontFamily,fontSize:settingData.blogContFont.value.fontSize,color:settingData.blogContFont.value.color,fontWeight:settingData.blogContFont.value.fontWeight,fontStyle:settingData.blogContFont.value.fontStyle,lineHeight:settingData.ContLineHeight.num,textAlign:settingData.ContcontrolRowAlign.value,marginBottom:settingData.blogDetailsShow.value?0:settingData.firstHeight.value}"
              >
              </div>
              <div
                class="zm-component-blog-viewMore"
                :style="{display:settingData.blogDetailsShow.num,textAlign:settingData.DiscontrolRowAlign.value,paddingTop:settingData.DismarginTop.value,marginTop:parseInt(settingData.lineHeightNum.value)!=0?settingData.firstHeight.value:0}"
              >
                <a
                  class="zm-component-details"
                  :style="{width:settingData.detailsWidth.value + '%',height:settingData.detailsHeight.value,lineHeight:settingData.detailsHeight.value,backgroundColor:settingData.detailsBackColor.value,fontFamily:settingData.detailsFont.value.fontFamily,fontSize:settingData.detailsFont.value.fontSize,color:settingData.detailsFont.value.color,fontWeight:settingData.detailsFont.value.fontWeight,fontStyle:settingData.detailsFont.value.fontStyle}"
                >
  ...
  >
    ...
    >
      <div
        ...
        :data-time="item.fUpdateTime"
        :data-title="item.fTitle"
        :style="{backgroundColor:settingData.BoxBackgroundColor.value,padding:'16px 10px'}"
      >
        <div class="zm-component-blog-detail">
          <div class="zm-component-blog-upcont" :style="{marginBottom:settingData.mobShowDet.value?0:-(parseFloat(settingData.mobContLine.num)-parseFloat(settingData.mobCont.value))/2 +'px'}">
            <div
              class="zm-component-blog-title"
