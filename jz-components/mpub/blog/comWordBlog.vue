  ...
  >
    ...
    >
      <a
        ...
        :style="{paddingTop:settingData.mobTitLine.value==1?'12px':12-(((1.3*14)-14)/2) +'px',paddingBottom:'12px',cursor:'pointer'}"
      >
        <a
          class="zm-component-blog-title"
          :style="{height:(settingData.mobTitLine.value==1?(1.2*14)*1:(1.2*14)*2) +'px',fontFamily:settingData.Familyfont.value.fontFamily,lineHeight:'1.3'}"
        >
          {{item.fTitle}}
        </a>
        <a
