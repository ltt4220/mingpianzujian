<template>
  <div v-if="settingData.mobileComIsHide" class="zm-component-main-blog" :id="id" :style="{position: 'absolute', width: mobileStyle.width+'px',height: mobileStyle.height+'px',left: mobileStyle.left+'px',top: mobileStyle.top+'px',zIndex:mobileStyle.zindex,boxShadow:settingData.pictureShadow.num}">
    <div ref="content" class="zm-component-blog-content mobileLeft" :data-num="settingData.mobBlogNum.value">
      <a v-for="(item,i) in setMobList" @click.stop="detaileWapurl" :key="i" class="zm-component-blog-box" :data-sortid="item.fId" :data-show="true" :data-time="item.fUpdateTime" :data-title="item.fTitle">
        <div class="zm-component-blog-mediaBox medialBoxOne" :style="{width:settingData.mobileHeight.value}">
          <a class="zm-component-blog-bgImg" @click.stop="detaileWapurl" :data-sortid="item.fId" :data-show="item.ahref" :style="{display:item.imgDis,backgroundImage:'url('+item.bgUrl+')'}">
          </a>
          <a class="zm-component-blog-bgVideo" @click.stop="detaileWapurl" :style="{display:item.videoDis}">
        ...
        <div class="zm-component-blog-detail">
          <div class="zm-component-blog-upcont">
            <a class="zm-component-blog-title" @click.stop="detaileWapurl" :style="{fontFamily:settingData.Familyfont.value.fontFamily,fontStyle:settingData.Familyfont.value.fontStyle,fontWeight:settingData.Familyfont.value.fontWeight,fontSize:settingData.mobTitle.value,lineClamp: 2,boxOrient:'vertical'}">
              {{item.fTitle}}
            </a>
            <div class="zm-component-blog-date" :style="{fontFamily:settingData.blogTimeFont.value.fontFamily,fontSize:settingData.mobDate.value,fontWeight:settingData.blogTimeFont.value.fontWeight,fontStyle:settingData.blogTimeFont.value.fontStyle,display:settingData.mobBlogShow.num}">{{item.fTime}}
            </div>
          </div>
        </div>
      </a>
...
<script>
import computed from "./onlyBlog/computed.js";
export default {
  name: "com-Picture-only-blog",
  props: {
    prop: {
      type: Object,
      required: true
